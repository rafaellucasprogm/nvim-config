...
vim.api.nvim_set_hl(0, '@keyword.type', { link = 'Structure' })
...
vim.api.nvim_set_hl(0, '@markup.raw', { link = 'Comment' })
...
vim.api.nvim_set_hl(0, 'Comment', { fg = 3815994 })
vim.api.nvim_set_hl(0, 'Conceal', { ctermfg = 243, fg = 7763574 })
vim.api.nvim_set_hl(0, 'Conditional', { link = 'Keyword' })
vim.api.nvim_set_hl(0, 'Constant', { fg = 11184810 })
vim.api.nvim_set_hl(0, 'CurSearch', { bg = 13421772, fg = 0 })
vim.api.nvim_set_hl(0, 'Cursor', { bg = 16756575, fg = 1842204 })
vim.api.nvim_set_hl(0, 'CursorColumn', { bg = 3158064, ctermbg = 236 })
vim.api.nvim_set_hl(0, 'CursorLine', { bg = 1644825 })
vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = 11184810 })
vim.api.nvim_set_hl(0, 'Debug', { ctermfg = 66, fg = 6260615 })
...
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineOk', { cterm = { underline = true }, sp = 9498256, underline = true })
...
vim.api.nvim_set_hl(0, 'FloatFooter', { link = 'Title' })
...
vim.api.nvim_set_hl(0, 'LineNrAbove', { ctermfg = 240, fg = 5789784 })
vim.api.nvim_set_hl(0, 'LineNrBelow', { ctermfg = 240, fg = 5789784 })
...
vim.api.nvim_set_hl(0, 'PmenuExtra', { bg = 3815994, ctermbg = 237, ctermfg = 243, fg = 7763574 })
vim.api.nvim_set_hl(0, 'PmenuExtraSel', { bg = 11513735, ctermbg = 144, ctermfg = 234, fg = 1842204 })
vim.api.nvim_set_hl(0, 'PmenuKind', { bg = 3815994, ctermbg = 237, ctermfg = 173, fg = 14124895 })
vim.api.nvim_set_hl(0, 'PmenuKindSel', { bg = 11513735, ctermbg = 144, ctermfg = 167, fg = 14114655 })
...
vim.api.nvim_set_hl(0, 'SpecialKey', { ctermfg = 240, fg = 5789784 })
...
vim.api.nvim_set_hl(0, 'WildMenu', { bg = 14145415, ctermbg = 186, ctermfg = 234, fg = 1842204 })
vim.api.nvim_set_hl(0, 'WinBar', { bold = true, cterm = { bold = true } })
vim.api.nvim_set_hl(0, 'WinBarNC', { link = 'WinBar' })
vim.api.nvim_set_hl(0, 'WinSeparator', { fg = 4473924 })
vim.api.nvim_set_hl(0, 'diffSubname', { ctermfg = 139, fg = 11503535 })
vim.api.nvim_set_hl(0, 'lCursor', { bg = 6291200, fg = 1842204 })
